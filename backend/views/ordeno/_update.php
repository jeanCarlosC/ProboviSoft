...
<div class="ordeno-form">
    ...
    <div class='col-md-6'>
    <?= $form->field($model, 'turnos')->dropDownList([ '1' => '1', '2' => '2',], ['prompt' => 'numero ordeños...']) ?>
    </div>
    <div class='col-md-6'>
    <?= $form->field($model, 'pesaje')->textInput() ?>
    </div>
...
if(typeof $("#ordeno-animal_identificacion") == 'undefined'){
document.getElementById("ordeno-animal_identificacion").disabled=false;
}
else
{
document.getElementById("ordeno-animal_identificacion").disabled=true;    
}
});
JS;
